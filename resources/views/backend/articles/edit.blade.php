...
@section('main_content')
    <div class="card-body collapse in">
        <div class="card-block">
            ...
            <form method="POST" action="{{route('articles.update', $article->id)}}" class="form form-horizontal">
                {{csrf_field()}}
                {{method_field('PUT')}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input maxlength="255" value="{{$article->title}}" type="text" name="title" id="title" class="form-control border-primary"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea rows="10" name="body" id="body" class="form-control border-primary"
                                              placeholder="Body" required="required">{{$article->body}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
